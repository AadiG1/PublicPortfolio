...
- Breaking the project into prompts was key — and the source of my annoyance — because it became apparent how crucial prompt engineering is, since AI needs precision. I started with a general command: “Build a personal portfolio website.” Once Cursor generated a foundation, I divided the work into smaller prompts to get all the requirements:
  ...
  - Write a Dockerfile for containerized deployment to Cloud Run. Each short, specific prompt gave more accurate results than broad ones. I learned to write prompts like code comments, clear, technical, and outcome-focused.
...
- This experience changed how I see software development as a career, and not for the better. As a software developer, I now see coding less as working through problems and requirements for businesses and more as guiding intelligent systems. “Knowing how to code” means understanding logic, structure, and clarity well enough to instruct AI effectively. In the future, I will use AI tools as accelerators, especially for setup, documentation, and testing. AI will help me move from planning to execution faster, especially when setting up Dockerfiles, since they are a pain to write and edit when issues arise. Still, AI will never replace creativity, teamwork, or problem-solving. Those will always depend on human judgment, empathy, and the ability to connect technical work to tangible goals.
